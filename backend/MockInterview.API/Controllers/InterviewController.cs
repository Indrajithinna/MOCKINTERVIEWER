...
namespace MockInterview.API.Controllers
{
    ...
    public class InterviewController : ControllerBase
    {
        ...
        {
            { LanguageCodes.English, new() { "Explain Dependency Injection and its benefits.", "What is the difference between an Abstract Class and an Interface?", "How do you handle error management in a Web API?", "What are Solid principles? Explain one of them.", "Explain Polymorphism with a real-world example." } },
            { LanguageCodes.Hindi, new() { "डिपेंडेंसी इंजेक्शन और इसके लाभों की व्याख्या करें।", "एब्स्ट्रेक्ट क्लास और इंटरफेस में क्या अंतर है?", "आप वेब एपीआई में त्रुटि प्रबंधन (error management) को कैसे सँभालते हैं?", "सॉलिड (SOLID) सिद्धांत क्या हैं? उनमें से एक की व्याख्या करें।", "वास्तवિક दुनिया के उदाहरण के साथ बहुरूपता (Polymorphism) की व्याख्या करें।" } },
            { LanguageCodes.Kannada, new() { "ಡಿಪೆಂಡೆನ್ಸಿ ಇಂಜೆಕ್ಷನ್ ಮತ್ತು ಅದರ ಉಪಯೋಗಗಳನ್ನು ವಿವರಿಸಿ.", "ಅಮೂರ್ತ ವರ್ಗ (Abstract Class) ಮತ್ತು ಇಂಟರ್ಫೇಸ್ ನಡುವಿನ ವ್ಯತ್ಯಾಸವೇನು?", "ವೆಬ್ API ಯಲ್ಲಿ ದೋಷ ನಿರ್ವಹಣೆಯನ್ನು (error management) ಹೇಗೆ ನಿಭಾಯಿಸುತ್ತೀರಿ?", "ಸಾಲಿಡ್ (SOLID) ತತ್ವಗಳೆಂದರೇನು? ಅವುಗಳಲ್ಲಿ ಒಂದನ್ನು ವಿವರಿಸಿ.", "ನೈಜ ಪ್ರಪಂಚದ ಉದಾಹರಣೆಯೊಂದಿಗೆ ಪಾಲಿಮಾರ್ಫಿಸಂ (Polymorphism) ವಿವರಿಸಿ." } },
            { LanguageCodes.Telugu, new() { "డిపెండెన్సీ ఇంజెక్షన్ మరియు దాని ప్రయోజనాలను వివరించండి.", "అబ్‌స్ట్రాక్ట్ క్లాస్ మరియు ఇంటర్‌ఫేస్ మధ్య తేడా ఏమిటి?", "వెబ్ API లో ఎర్రర్ మేనేజ్‌మెంట్‌ను ఎలా నిర్వహిస్తారు?", "సాలిడ్ (SOLID) సూత్రాలు ఏమిటి? వాటిలో ఒకదాన్ని వివరించండి.", "నిజ జీవిత ఉదాహరణతో పాలిమార్ఫిజం (Polymorphism) ను వివరించండి." } },
        ...
        [HttpGet("questions")]
        public async Task<ActionResult<string>> GetRandomQuestion([FromQuery] string language = LanguageCodes.English)
        {
            var langKey = LanguageCodes.IsSupported(language) ? language : LanguageCodes.English;
